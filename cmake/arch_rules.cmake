...
foreach(_ARCH_RULES_REL IN LISTS _ARCH_RULES_FILES)
    ...
    foreach(_ARCH_RULES_LINE IN LISTS _ARCH_RULES_INCLUDE_LINES)
        ...
        if(_ARCH_RULES_HEADER STREQUAL "dsd-neo/io/m17_udp.h")
            if(_ARCH_RULES_REL MATCHES "^(src/core/|src/dsp/|src/protocol/)")
                message(SEND_ERROR "ARCH_RULES: ${_ARCH_RULES_REL}: forbidden m17_udp include '${_ARCH_RULES_HEADER}'")
                math(EXPR _ARCH_RULES_VIOLATIONS "${_ARCH_RULES_VIOLATIONS} + 1")
            endif()
            continue()
        endif()

        if(_ARCH_RULES_HEADER STREQUAL "dsd-neo/io/udp_bind.h")
            if(_ARCH_RULES_REL MATCHES "^(src/core/|src/dsp/|src/protocol/)")
                message(SEND_ERROR "ARCH_RULES: ${_ARCH_RULES_REL}: forbidden udp_bind include '${_ARCH_RULES_HEADER}'")
                math(EXPR _ARCH_RULES_VIOLATIONS "${_ARCH_RULES_VIOLATIONS} + 1")
            endif()
            continue()
        endif()
