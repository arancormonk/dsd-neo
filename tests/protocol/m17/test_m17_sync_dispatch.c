...
test_synctype_helpers(void) {
    static const int m17_synctypes[] = {
        DSD_SYNC_M17_STR_POS, DSD_SYNC_M17_STR_NEG, DSD_SYNC_M17_LSF_POS, DSD_SYNC_M17_LSF_NEG, DSD_SYNC_M17_BRT_POS,
        DSD_SYNC_M17_BRT_NEG, DSD_SYNC_M17_PKT_POS, DSD_SYNC_M17_PKT_NEG, DSD_SYNC_M17_PRE_POS, DSD_SYNC_M17_PRE_NEG,
    };
...
static void
test_reserved_bert_dispatch(void) {
