...
assert_frontend_snapshot_fields(const dsd_frontend_snapshot* snap) {
    ...
    assert(snap->p25.p25_site_lra_valid == 1U);
    assert(snap->p25.p25_site_lra == 0x22U);
    assert(snap->p25.p25_site_network_active_valid == 1U);
    assert(snap->p25.p25_site_network_active == 1U);
    assert(snap->p25.p25_sys_services_valid == 1U);
    assert(snap->p25.p25_sys_services_available == 0x00ABCDEFU);
    assert(snap->p25.p25_sys_services_supported == 0x00123456U);
    assert(snap->p25.p25_sys_services_request_priority == 7U);
    assert(strstr(snap->p25.p25_sys_services_available_names, "group voice") != NULL);
    assert(strstr(snap->p25.p25_sys_services_supported_names, "unit status query") != NULL);
    assert(snap->p25.p25_cc_prot_valid == 1U);
    assert(snap->p25.p25_cc_prot_algid == 0x84U);
    assert(snap->p25.p25_sys_time_valid == 1U);
    assert(snap->p25.p25_sys_time_unix_s == 1770000000);
    assert(snap->p25.p25_sys_time_offset_valid == 1U);
    assert(snap->p25.p25_sys_time_offset_minutes == -300);
    ...
    assert(snap->p25.neighbor_count == 2U);
    assert(snap->p25.neighbors[0].present == 1U);
    assert(snap->p25.neighbors[0].freq_hz == 851006250L);
    assert(snap->p25.neighbors[0].wacn == 0xbee00U);
    assert(snap->p25.neighbors[0].wacn_valid == 1U);
    assert(snap->p25.neighbors[0].sysid == 0x123U);
    assert(snap->p25.neighbors[0].rfss == 4U);
    assert(snap->p25.neighbors[0].site == 5U);
    assert(snap->p25.neighbors[0].cfva == 2U);
    assert(snap->p25.neighbors[0].lra == 0x44U);
    assert(snap->p25.neighbors[0].lra_valid == 1U);
    assert(snap->p25.neighbors[0].cfva_valid == 1U);
    assert(snap->p25.neighbors[0].last_seen_unix_s == 1770001000);
    assert(snap->p25.neighbors[1].freq_hz == 852006250L);
    assert(snap->p25.neighbors[1].wacn_valid == 0U);
    assert(snap->p25.neighbors[1].cfva_valid == 0U);
    assert(snap->p25.secondary_cc_count == 1U);
    assert(snap->p25.secondary_ccs[0].present == 1U);
    assert(snap->p25.secondary_ccs[0].freq_hz == 853006250L);
    assert(snap->p25.secondary_ccs[0].channel == 0x1234U);
    assert(snap->p25.secondary_ccs[0].rfss == 4U);
    assert(snap->p25.secondary_ccs[0].site == 5U);
    assert(snap->p25.secondary_ccs[0].system_service_class == 0xA0U);
    assert(snap->p25.secondary_ccs[0].last_seen_unix_s == 1770001002);
    assert(snap->p25.iden_plan_count == 2U);
    assert(snap->p25.iden_plan_confirmed_count == 1U);
    assert(snap->p25.iden_plan[0].present == 1U);
    assert(snap->p25.iden_plan[0].id == 1U);
    assert(snap->p25.iden_plan[0].tdma == 0U);
    assert(snap->p25.iden_plan[0].trust == 2U);
    assert(snap->p25.iden_plan[0].base_freq_hz == 851000000L);
    assert(snap->p25.iden_plan[0].spacing_hz == 12500);
    assert(snap->p25.iden_plan[0].bandwidth == 5U);
    assert(snap->p25.iden_plan[0].bandwidth_hz == 12500);
    assert(snap->p25.iden_plan[0].wacn == 0xbee00ULL);
    assert(snap->p25.iden_plan[1].id == 1U);
    assert(snap->p25.iden_plan[1].tdma == 1U);
    assert(snap->p25.iden_plan[1].channel_type == 3U);
    assert(snap->p25.iden_plan[1].base_freq_hz == 851000000L);
    assert(snap->p25.iden_plan[1].spacing_hz == 6250);
    assert(snap->p25.iden_plan[1].bandwidth_hz == 0);

    assert(snap->active_channel_count == 2U);
    assert(snap->active_channels[0].present == 1U);
    assert(snap->active_channels[0].slot == 0U);
    assert(snap->active_channels[0].protocol == DSD_FRONTEND_PROTOCOL_P25);
    assert(snap->active_channels[0].target_id == 321U);
    assert(snap->active_channels[0].source_id == 654U);
    assert(snap->active_channels[0].p25_vc_freq == 851506250L);
    assert(snap->active_channels[0].trunk_vc_freq == 769506250L);
    assert(snap->active_channels[0].audio_allowed == 1);
    assert(snap->active_channels[1].present == 1U);
    assert(snap->active_channels[1].target_id == 987U);
    assert(snap->active_channels[1].source_id == 765U);
    assert(snap->active_channels[1].p25_vc_freq == 852506250L);
...
main(void) {
    ...
    state->trunk_vc_freq[1] = 770506250L;
    state->p25_cc_freq = 851006250L;
    state->p25_vc_freq[0] = 851506250L;
    state->p25_vc_freq[1] = 852506250L;
    ...
    state->p25_nb_count = 2;
    state->p25_nb_entries[0].freq = 851006250L;
    state->p25_nb_entries[0].wacn = 0xbee00U;
    state->p25_nb_entries[0].wacn_valid = 1U;
    state->p25_nb_entries[0].sysid = 0x123U;
    state->p25_nb_entries[0].rfss = 4U;
    state->p25_nb_entries[0].site = 5U;
    state->p25_nb_entries[0].cfva = 2U;
    state->p25_nb_entries[0].lra = 0x44U;
    state->p25_nb_entries[0].lra_valid = 1U;
    state->p25_nb_entries[0].cfva_valid = 1U;
    state->p25_nb_entries[0].last_seen = 1770001000;
    state->p25_nb_entries[1].freq = 852006250L;
    state->p25_nb_entries[1].sysid = 0x123U;
    state->p25_nb_entries[1].rfss = 6U;
    state->p25_nb_entries[1].site = 7U;
    state->p25_nb_entries[1].cfva = 1U;
    state->p25_nb_entries[1].last_seen = 1770001001;
    state->p25_secondary_cc_count = 1;
    state->p25_secondary_cc_entries[0].freq = 853006250L;
    state->p25_secondary_cc_entries[0].channel = 0x1234U;
    state->p25_secondary_cc_entries[0].rfss = 4U;
    state->p25_secondary_cc_entries[0].site = 5U;
    state->p25_secondary_cc_entries[0].ssc = 0xA0U;
    state->p25_secondary_cc_entries[0].last_seen = 1770001002;
    state->p25_iden_fdma[1].populated = 1U;
    state->p25_iden_fdma[1].trust = 2U;
    state->p25_iden_fdma[1].base_freq = 851000000L / 5L;
    state->p25_iden_fdma[1].chan_type = 1;
    state->p25_iden_fdma[1].chan_spac = 100;
    state->p25_iden_fdma[1].trans_off = 2200;
    state->p25_iden_fdma[1].bw_vu = 5U;
    state->p25_iden_fdma[1].wacn = 0xbee00ULL;
    state->p25_iden_fdma[1].sysid = 0x123ULL;
    state->p25_iden_tdma[1].populated = 1U;
    state->p25_iden_tdma[1].trust = 1U;
    state->p25_iden_tdma[1].base_freq = 851000000L / 5L;
    state->p25_iden_tdma[1].chan_type = 3;
    state->p25_iden_tdma[1].chan_spac = 50;
    state->p25_iden_tdma[1].trans_off = 4400;
