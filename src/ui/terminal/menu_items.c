...
static const NcMenuItem TRUNK_P25_ITEMS[] = {
    ...
    {.id = "p25_enc",
     .label = "Encrypted Call Lockout",
     .label_fn = lbl_p25_enc_lockout,
     .help = "Lock confirmed-encrypted targets out for the session; key loads re-check them.",
     .on_select = act_p25_enc_lockout},
    {.id = "enc_lo_clear",
     .label = "Clear Encryption Lockouts",
...
const NcMenuItem DSP_TED_ITEMS[] = {
    {.id = "ted_gain_status",
     .label = "CQPSK Timing Gain (status)",
     .label_fn = lbl_ted_gain,
     .help = "CQPSK Gardner timing loop gain.",
     .is_enabled = is_ted_allowed},
    {.id = "ted_gain+",
     .label = "CQPSK Timing Gain +",
     .help = "Increase CQPSK Gardner timing loop gain.",
     .is_enabled = is_ted_allowed,
     .on_select = act_ted_gain_up},
    {.id = "ted_gain-",
     .label = "CQPSK Timing Gain -",
     .help = "Decrease CQPSK Gardner timing loop gain.",
     .is_enabled = is_ted_allowed,
     .on_select = act_ted_gain_dn},
    {.id = "cqpsk_timing_bias",
     .label = "CQPSK Timing Bias (status)",
...
const NcMenuItem DSP_MENU_ITEMS[] = {
    ...
    {.id = "dsp.ted",
     .label = "CQPSK Timing...",
     .help = "CQPSK Gardner timing parameters.",
