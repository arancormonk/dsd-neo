...
static const NcMenuItem DSP_PATH_ITEMS[] = {
    ...
    {.id = "fll",
     ...
     .help = "Enable/disable non-symbol residual FLL outside RTL symbol digital paths.",
     .is_enabled = is_fll_allowed,
     .on_select = act_toggle_fll},
    {.id = "ted",
     .label = "Timing Error (TED)",
     .label_fn = lbl_onoff_ted,
     .help = "Toggle non-symbol TED outside RTL symbol digital paths.",
     .is_enabled = is_ted_allowed,
     .on_select = act_toggle_ted},
    {.id = "ted_force",
     .label = "TED Force",
     .label_fn = lbl_ted_force,
     .help = "Force TED for non-symbol FM paths.",
     .is_enabled = is_non_symbol_mod_fm,
     .on_select = act_ted_force_toggle},
    {.id = "c4fm_clk",
     .label = "C4FM Clock Assist",
     .label_fn = lbl_c4fm_clk,
     .help = "Cycle sample-window C4FM timing assist: Off → EL → MM.",
     .is_enabled = is_sample_window_c4fm,
     .on_select = act_c4fm_clk_cycle},
    {.id = "c4fm_clk_sync",
     .label = "C4FM Clock While Synced",
     .label_fn = lbl_c4fm_clk_sync,
     .help = "Allow sample-window clock assist to remain active while synchronized.",
     .is_enabled = is_sample_window_c4fm,
...
const NcMenuItem DSP_AGC_ITEMS[] = {
    {.id = "fm_agc",
     .label = "FM AGC",
     .label_fn = lbl_fm_agc,
     .help = "Toggle non-symbol pre-discriminator FM AGC.",
     .is_enabled = is_non_symbol_mod_fm,
    ...
    {.id = "fm_lim",
     ...
     .help = "Toggle non-symbol constant-envelope limiter.",
     .is_enabled = is_non_symbol_mod_fm,
    ...
    {.id = "fm_tgt",
     ...
     .is_enabled = is_non_symbol_mod_fm},
    {.id = "fm_tgt+",
     .label = "AGC Target +0.02",
     .is_enabled = is_non_symbol_mod_fm,
     .on_select = act_fm_agc_target_up},
    {.id = "fm_tgt-",
     .label = "AGC Target -0.02",
     .is_enabled = is_non_symbol_mod_fm,
     .on_select = act_fm_agc_target_dn},
    {.id = "fm_min",
     .label = "AGC Min (status)",
     .label_fn = lbl_fm_agc_min,
     .help = "Min RMS to engage AGC.",
     .is_enabled = is_non_symbol_mod_fm},
    {.id = "fm_min+", .label = "AGC Min +0.01", .is_enabled = is_non_symbol_mod_fm, .on_select = act_fm_agc_min_up},
    {.id = "fm_min-", .label = "AGC Min -0.01", .is_enabled = is_non_symbol_mod_fm, .on_select = act_fm_agc_min_dn},
    {.id = "fm_au",
    ...
    {.id = "fm_au+",
     .label = "Alpha Up +0.05",
     .is_enabled = is_non_symbol_mod_fm,
     .on_select = act_fm_agc_alpha_up_up},
    {.id = "fm_au-",
     .label = "Alpha Up -0.05",
     .is_enabled = is_non_symbol_mod_fm,
     .on_select = act_fm_agc_alpha_up_dn},
    {.id = "fm_ad",
     ...
     .is_enabled = is_non_symbol_mod_fm},
    {.id = "fm_ad+",
     .label = "Alpha Down +0.05",
     .is_enabled = is_non_symbol_mod_fm,
     .on_select = act_fm_agc_alpha_down_up},
    {.id = "fm_ad-",
     .label = "Alpha Down -0.05",
     .is_enabled = is_non_symbol_mod_fm,
     .on_select = act_fm_agc_alpha_down_dn},
};
...
const NcMenuItem DSP_CQPSK_EQ_ITEMS[] = {
    {.id = "cq_eq",
     .label = "CMA Equalizer",
     .label_fn = lbl_cqpsk_eq,
     .help = "Toggle CQPSK blind CMA equalizer.",
     .is_enabled = is_mod_qpsk,
     .on_select = act_cqpsk_eq_toggle},
    {.id = "cq_eq_taps",
     .label = "CMA Taps (status)",
     .label_fn = lbl_cqpsk_eq_taps,
     .help = "Odd FIR tap count, clamped to 3..15.",
     .is_enabled = is_mod_qpsk},
    {.id = "cq_eq_taps+",
     .label = "CMA Taps +2",
     .help = "Increase equalizer tap count.",
     .is_enabled = is_mod_qpsk,
     .on_select = act_cqpsk_eq_taps_up},
    {.id = "cq_eq_taps-",
     .label = "CMA Taps -2",
     .help = "Decrease equalizer tap count.",
     .is_enabled = is_mod_qpsk,
     .on_select = act_cqpsk_eq_taps_dn},
    {.id = "cq_eq_mu",
     .label = "CMA Mu (status)",
     .label_fn = lbl_cqpsk_eq_mu,
     .help = "Adaptation step, clamped to 0.000001..0.01.",
     .is_enabled = is_mod_qpsk},
    {.id = "cq_eq_mu+",
     .label = "CMA Mu +0.0001",
     .help = "Increase equalizer adaptation step.",
     .is_enabled = is_mod_qpsk,
     .on_select = act_cqpsk_eq_mu_up},
    {.id = "cq_eq_mu-",
     .label = "CMA Mu -0.0001",
     .help = "Decrease equalizer adaptation step.",
     .is_enabled = is_mod_qpsk,
     .on_select = act_cqpsk_eq_mu_dn},
    {.id = "cq_eq_mod",
     .label = "CMA Modulus (status)",
     .label_fn = lbl_cqpsk_eq_modulus,
     .help = "Target output magnitude squared, clamped to 0.05..4.0.",
     .is_enabled = is_mod_qpsk},
    {.id = "cq_eq_mod+",
     .label = "CMA Modulus +0.05",
     .help = "Increase equalizer target modulus.",
     .is_enabled = is_mod_qpsk,
     .on_select = act_cqpsk_eq_modulus_up},
    {.id = "cq_eq_mod-",
     .label = "CMA Modulus -0.05",
     .help = "Decrease equalizer target modulus.",
     .is_enabled = is_mod_qpsk,
     .on_select = act_cqpsk_eq_modulus_dn},
    {.id = "cq_eq_reset",
     .label = "Reset CMA Equalizer",
     .help = "Re-center taps and clear adaptation metrics.",
     .is_enabled = is_mod_qpsk,
     .on_select = act_cqpsk_eq_reset},
};
const size_t DSP_CQPSK_EQ_ITEMS_LEN = sizeof DSP_CQPSK_EQ_ITEMS / sizeof DSP_CQPSK_EQ_ITEMS[0];
...
const NcMenuItem DSP_MENU_ITEMS[] = {
    ...
    {.id = "dsp.agc",
     .label = "AGC & Limiter...",
     .help = "Non-symbol FM AGC, limiter, and parameters.",
    ...
    {.id = "dsp.cqpsk_eq",
     .label = "CQPSK Equalizer...",
     .help = "CMA multipath/ISI mitigation controls.",
     .submenu = DSP_CQPSK_EQ_ITEMS,
     .submenu_len = sizeof DSP_CQPSK_EQ_ITEMS / sizeof DSP_CQPSK_EQ_ITEMS[0],
     .is_enabled = dsp_cqpsk_eq_any},
};
