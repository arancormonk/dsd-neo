...
/**
 * @file
 * @brief Frontend-neutral public types shared by app-control and core config storage.
 */

#ifndef DSD_NEO_INCLUDE_DSD_NEO_APP_CONTROL_FRONTEND_TYPES_H_
#define DSD_NEO_INCLUDE_DSD_NEO_APP_CONTROL_FRONTEND_TYPES_H_
...
#endif /* DSD_NEO_INCLUDE_DSD_NEO_APP_CONTROL_FRONTEND_TYPES_H_ */
